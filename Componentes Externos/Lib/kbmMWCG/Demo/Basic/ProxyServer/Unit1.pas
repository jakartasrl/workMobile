...
uses
  ...
  kbmMWInventoryService,
  kbmMWTCPIPIndyTransport,
  kbmMWCustomConnectionPool,
  kbmMemTable, kbmMWGlobal, kbmMWSecurity, 
  kbmMWClient, kbmMWClientDataset, kbmMWTCPIPIndyClientTransport,
...
begin
     ...
     sd:=kbmMWServer1.RegisterService(TProxyService,true);
end;
