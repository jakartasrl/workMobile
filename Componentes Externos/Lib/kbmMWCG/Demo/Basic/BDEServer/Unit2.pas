...
type
  TTestQuery = class(TkbmMWQueryService)
    ...
    procedure kbmMWQueryServiceAuthenticateMetaData(Sender: TObject;
      Query: TkbmMWCustomPooledCursor; ClientIdent: TkbmMWClientIdentity;
      DataType: TkbmMWMetaDataType;
...
procedure TTestQuery.kbmMWQueryServiceAuthenticateMetaData(Sender: TObject;
  Query: TkbmMWCustomPooledCursor; ClientIdent: TkbmMWClientIdentity;
  DataType: TkbmMWMetaDataType; var Permissions: TkbmMWAccessPermissions);
begin
