...
public class PropertySolver {
   ...
   private String armarMetodo(String aName){
	 ...
	 * @throws ExceptionDS
	 */
   public Object resolveMethodInvocation(String aName, Object aPersistente) throws ExceptionDS{
   ...
   public Method getMethod(String aName, Object aObj) throws ExceptionDS{
