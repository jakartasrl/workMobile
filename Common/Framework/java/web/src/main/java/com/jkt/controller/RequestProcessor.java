...
public abstract class RequestProcessor extends BaseController{
	...
	public void handleXML(HttpServletRequest request, HttpServletResponse response)throws Exception,EntityNotFoundException {
		...
		log.info("Adaptando la entrada de parametros de acuerdo a la operaci�n solicitada...");
...
//			parametersAdapted = new HashMap<String, String>();
		...
		log.info("Recuperando un transformer para la operaci�n actual...");
		...
		log.info("Ejecutando la operaci�n...");
		if (test){
		...
		log.info("Enviando resultados de la operaci�n...");
		transformer.write();
		
		}finally{
			sessionProvider.destroySession();
		}
		log.info("Finaliz� la operaci�n...");
	}

	protected void getEventBusinessOperation(String operationName) {
		log.info("Ejecutando la operaci�n "+operationName+".");
	...
	private void finalizar(String aOperName) throws JakartaException {
		log.info("La operaci�n " + aOperName + " no existe en operaciones.xml .Se finaliza la petici�n.");
