...
//			}
	...
	private void finalizar() throws JakartaException {
		log.debug("No existe la operaci�n solicitada.Se finaliza la petici�n.");
		throw new JakartaException("No existe la operaci�n solicitada.Se finaliza la petici�n.Compruebe el archivo XML y el nombre dado a la operacion.");
	}
