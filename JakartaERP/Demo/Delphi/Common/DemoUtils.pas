...
function CreateLookAndFeelMenuItems(AOwner: TComponent; AGroupIndex: Integer = 1): TMenuItem;
...
{$ELSE}
  Result := (Sender as TMenuItem).Checked;
{$ENDIF}
end;
...
var
  ...
  begin
    ...
    Result.Tag := ATag;
    AParent.Add(Result);
    Result.Checked := FLookAndFeelController.NativeStyle and (ATag = 4) or
