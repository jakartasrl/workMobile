 ...
 */
public class TraerDeterminacionesConPrecio extends Operation {
	...
	private List obtenerDeterminacionesConPrecios(long idLista, long idLaboratorio){
		String hqlDeterminaciones="ListaPrecioDetalle precios where precios.listaPrecios.id= :idLista"
