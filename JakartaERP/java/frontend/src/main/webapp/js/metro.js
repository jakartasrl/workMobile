        ...
        _build: function() {
            ...
            $(Metro.data).each(function(index, container_data) {
                ...
                $(container_data.tiles).each(function(widget_index, widget_data) {
                    var background_colour = widget_data.colour !== undefined ? 'background-color:' + widget_data.colour + ';' : '';
                    var background_image  = widget_data.thumbnail.length ? 'background-image:url(\'' + widget_data.thumbnail + '\');"' : '';

                    var widget_html = '';
                    widget_html += '<div class="widget widget' + widget_data.size + ' widget_' + widget_data.theme + (widget_data.link !== undefined ? ' widget_link' : '') + ' animation unloaded"' + (widget_data.colour !== undefined ? ' style="background-color:' + widget_data.colour + ';"' : '') + '  data-url="' + widget_data.url + '" data-theme="' + widget_data.theme + '" data-name="' + widget_data.name + '"' + (widget_data.link !== undefined ? ' data-link="' + widget_data.link +'"' : '') + '>';
                    widget_html +=     '<div class="widget_content">';
                    widget_html +=         '<div class="main"' + (background_colour || background_image ? ' style="' + background_colour + background_image +  '"' : '') + '>';
