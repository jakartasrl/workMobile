...
@Data
public class ArticuloVM extends WorkMobileVM {
...
//			if("7798123690231".equals(codigoBarraCliente)){
	...
	private DescriptibleOV nuevoArticulo() {
		...
		articulo.setDescripcion("Descripcion " + String.valueOf(orden.getArticulos().size()*10000));
	...
	@Command
	public void cargarArticuloPorCodigo(){
		orden.setCodigoBarraArticulo("");
		Executions.sendRedirect("articuloCodigo.zul");
	}
