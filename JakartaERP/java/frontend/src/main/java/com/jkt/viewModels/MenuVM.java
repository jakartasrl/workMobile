...
public class MenuVM {
	...
	public void init(){
		...
		menues.add(MenuOV.newInstance("Planificaci�n de Agenda", "index/index-agenda.zul", "small"));
		...
		menues.add(MenuOV.newInstance("Documentaci�n", "generic/generic.zul", "small","guardarDocumentacion", "documentacion"));
